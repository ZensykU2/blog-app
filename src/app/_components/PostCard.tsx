      ...
      {isOwner && isHovered && (
        <div className="absolute top-4 right-4 flex gap-2 z-20 animate-fade-in">
          <Link href={`/edit/${post.id}`}>
            <button className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition backdrop-blur-md border border-white/10">
          ...
          <button
            ...
            className="p-2 rounded-full bg-red-500/10 hover:bg-red-500/20 transition backdrop-blur-md border border-white/10"
          >
