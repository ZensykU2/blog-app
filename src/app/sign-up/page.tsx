...
import { ArrowLeft, Mail, Lock, Eye, EyeOff, User, UserCircle } from "lucide-react";
                ...
                <div className="relative z-10">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-black tracking-tight text-white mb-2">
                            Join <span className="bg-gradient-to-r from-purple-400 to-indigo-400 bg-clip-text text-transparent">Inkwell</span>
                        </h1>
                        <p className="text-slate-400">Start your writing journey today</p>
                    </div>

                    {/* Google Sign Up */}
                    <button
                        onClick={handleGoogleSignUp}
                        className="w-full flex items-center justify-center gap-3 bg-white text-slate-900 font-bold py-4 px-6 rounded-xl hover:bg-slate-100 transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-white/10 cursor-pointer mb-6"
                    >
